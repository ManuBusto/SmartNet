...
function App() {
  ...
  // Funções de controle do modal de login
        ...
        {isCookieModalOpen && !showCookieSettings && (
          <div className="cookie-modal-overlay">
            <div className="cookie-modal-container">
              ...
              <button onClick={() => saveCookiePreferences({ essential: true, functional: true, analytics: true, marketing: true })}>
                Aceitar Todos
              </button>
              <button onClick={() => saveCookiePreferences({ essential: true, functional: false, analytics: false, marketing: false })}>
                Recusar
              </button>
